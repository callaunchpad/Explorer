...
class Agent:
    def __init__(self, input_size, output_size):
        ...
        self.hidden1 = tf.layers.dense(self.input_x, 30, kernel_initializer=tf.contrib.layers.xavier_initializer(), activation=tf.nn.leaky_relu)
        self.hidden2 = tf.layers.dense(self.hidden1, 30, kernel_initializer=tf.contrib.layers.xavier_initializer(), activation=tf.nn.leaky_relu)
